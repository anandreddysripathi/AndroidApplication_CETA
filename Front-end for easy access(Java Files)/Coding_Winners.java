...
public class Coding_Winners extends AppCompatActivity {
    private TextView mTextViewResult;
    private RequestQueue mQueue;
    String url="http://"+URLs.url1+"/ytvolley/cowinners.php";
    ...
    private void jsonParse() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url,
         ...
         MySingleton.getInstance(Coding_Winners.this).addToRequestque(request);
    }
}
