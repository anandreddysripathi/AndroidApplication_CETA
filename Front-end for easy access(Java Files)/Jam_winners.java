...
public class Jam_winners extends AppCompatActivity {
    private TextView mTextViewResult;
    private RequestQueue mQueue;
    String url="http://"+URLs.url1+"/ytvolley/jamwin.php";
    ...
    private void jsonParse() {
        ...
        MySingleton.getInstance(Jam_winners.this).addToRequestque(request);
    }
}
