...
public class LoginorRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder=new AlertDialog.Builder(LoginorRegister.this);
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                {
                                    Intent intent=new Intent("login_admin");
                                ...
                                else if(code.equals("login_success"))
                                {
                                    ...
                                    Bundle b=new Bundle();
                                    b.putString("name",jsonObject.getString("username"));
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(LoginorRegister.this,"Connect to Network",Toast.LENGTH_SHORT).show();
                    ...
                    MySingleton.getInstance(LoginorRegister.this).addToRequestque(stringRequest);
                }
            }
        });
    }
