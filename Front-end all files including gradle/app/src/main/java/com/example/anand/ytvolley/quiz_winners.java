...
public class quiz_winners extends AppCompatActivity {
    private TextView mTextViewResult;
    private RequestQueue mQueue;
    String url="http://"+URLs.url1+"/ytvolley/quizwin.php";
    ...
    private void jsonParse() {
        ...
        MySingleton.getInstance(quiz_winners.this).addToRequestque(request);
    }
}
